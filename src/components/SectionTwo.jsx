    ...
    return (
        <div className="section-two">
            <p className="section-two_welcome2">
                ...
                gallary? Please click below to enter into an emmersive view of
                virtual gallary...
            </p>
            <div className="btn-wrapper">
                <span className="btn-description"></span>
                <button className="btn_entrance">Emmersive-View</button>
            ...
            <div className="section-two_bottom-container">
                <div className="quote-container">
                    {showQuote && (
                        <p
                            className={`quote1 ${
                                animateQuote ? "animate-enter" : "animate-exit"
                            }`}
                ...
                <div className="image-container">
                    <img src="/src/assets/Portfolio-219.jpg" alt="" srcset="" />
                </div>
            </div>
        </div>
    );
